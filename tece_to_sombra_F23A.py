...
logFile = open('log_tece_to_sombra_F23A' + '.txt', 'w')
...
glitch = Glitch(int("0x0000F23A", 0), coordinate(90, 17))

McuInfo = MCU_Info(coordinate(0, 0), coordinate(239, 137), MinMax(0, 2))

ori_f = SombraImage(imgs[1] + extansion, McuInfo)
mod_f = SombraImage(imgs[0] + extansion, McuInfo)
